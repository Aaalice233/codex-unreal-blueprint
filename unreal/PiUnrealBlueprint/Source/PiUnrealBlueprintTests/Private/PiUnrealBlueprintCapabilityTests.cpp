...
namespace
{
    ...
    PiUnrealBlueprint::FComponentReference ComponentRef(const FString& Name)
    {
        PiUnrealBlueprint::FComponentReference Reference;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FPiAssetCrudAndKindsUnitTest,
    "PiUnrealBlueprint.Unit.Assets.CrudKindsStructEnumLevel", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FPiAssetCrudAndKindsUnitTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FPiTypesDefaultsAndComponentsUnitTest,
    "PiUnrealBlueprint.Unit.Blueprint.TypesDefaultsComponents", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FPiTypesDefaultsAndComponentsUnitTest::RunTest(const FString& Parameters)
{
    ...
    FBlueprintOperationResult Root = FBlueprintComponentOperations::Add(
        ...
        TOptional<PiUnrealBlueprint::FComponentReference>(), RootTransform);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FPiGraphAndActionCatalogUnitTest,
    "PiUnrealBlueprint.Unit.Graph.ActionCatalogAndSchema", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FPiGraphAndActionCatalogUnitTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FPiPublicAssetFamilyE2ETest,
    "PiUnrealBlueprint.E2E.PublicEntry.AssetFamily", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FPiPublicAssetFamilyE2ETest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FPiPublicInspectionLevelAndValidationTest,
    "PiUnrealBlueprint.PublicEntry.InspectLevelAndValidatePreflight", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FPiPublicInspectionLevelAndValidationTest::RunTest(const FString& Parameters)
{
    ...
    InvalidReference->SetStringField(TEXT("classPath"), TEXT("/Script/PiUnrealBlueprintTests.DoesNotExist"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FPiUmgAndAnimE2ETest,
    "PiUnrealBlueprint.E2E.PublicEntry.SpecializedUmgAndAnimBlueprint", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FPiUmgAndAnimE2ETest::RunTest(const FString& Parameters)
{
