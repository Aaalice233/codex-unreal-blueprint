...
namespace PiUnrealBlueprint
{
    namespace
    {
        ...
        class FPiUmgWriteOperation final : public IWriteOperation
        {
        public:
            FPiUmgWriteOperation(UWidgetBlueprint* InBlueprint, const TSharedRef<FJsonObject>& InOperation, int32 InIndex,
        ...
        FWritePipelineRequest& OutRequest, FUmgOperationError& OutError)
    {
        ...
        OutRequest.TransactionDescription = FString::Printf(TEXT("Pi UMG automation: %s"), *Blueprint->GetPathName());
        ...
        for (int32 Index = 0; Index < Operations.Num(); ++Index)
            OutRequest.Operations.Add(MakeShared<FPiUmgWriteOperation>(Blueprint, Operations[Index], Index, nullptr));
        return true;
    }
