...
#include "PiUnrealBlueprintAnimOperations.h"
#include "PiUnrealBlueprintAssetOperations.h"
#include "PiUnrealBlueprintComponentOperations.h"
#include "PiUnrealBlueprintGraphOperations.h"
#include "PiUnrealBlueprintTypeSystem.h"
#include "PiUnrealBlueprintUmgOperations.h"
...
#define PI_ADD(Name, Domain, ...) Add(TEXT(Name), TEXT(Domain), {__VA_ARGS__})
        Add(TEXT("asset.create"), TEXT("asset"), {});
        PI_ADD("asset.duplicate", "asset", {TEXT("destinationPath"), EFieldKind::String, true}); PI_ADD("asset.rename", "asset", {TEXT("destinationPath"), EFieldKind::String, true}); PI_ADD("asset.delete", "asset");
        PI_ADD("asset.parent.set", "asset", {TEXT("parentClassPath"), EFieldKind::String, true}); PI_ADD("asset.interface.add", "asset", {TEXT("interfaceClassPath"), EFieldKind::String, true}); PI_ADD("asset.interface.remove", "asset", {TEXT("interfaceClassPath"), EFieldKind::String, true}, {TEXT("preserveFunctions"), EFieldKind::Boolean, false}); PI_ADD("asset.redirector.fix", "asset"); PI_ADD("asset.levelBlueprint.getOrCreate", "asset"); PI_ADD("asset.classDefault.set", "asset", {TEXT("propertyPath"), EFieldKind::String, true}, {TEXT("value"), EFieldKind::Any, true});
        PI_ADD("component.add", "component", {TEXT("classPath"), EFieldKind::String, true}, {TEXT("variableName"), EFieldKind::String, true}, {TEXT("parent"), EFieldKind::Object, false}, {TEXT("transform"), EFieldKind::Object, false});
        PI_ADD("component.remove", "component", {TEXT("component"), EFieldKind::Object, true}, {TEXT("promoteChildren"), EFieldKind::Boolean, false}); PI_ADD("component.rename", "component", {TEXT("component"), EFieldKind::Object, true}, {TEXT("newName"), EFieldKind::String, true}); PI_ADD("component.attach", "component", {TEXT("component"), EFieldKind::Object, true}, {TEXT("parent"), EFieldKind::Object, false}); PI_ADD("component.root.set", "component", {TEXT("component"), EFieldKind::Object, true}); PI_ADD("component.transform.set", "component", {TEXT("component"), EFieldKind::Object, true}, {TEXT("transform"), EFieldKind::Object, true}); PI_ADD("component.property.set", "component", {TEXT("component"), EFieldKind::Object, true}, {TEXT("propertyPath"), EFieldKind::String, true}, {TEXT("value"), EFieldKind::Any, true}, {TEXT("createInheritedOverride"), EFieldKind::Boolean, false}); PI_ADD("component.override.clear", "component", {TEXT("component"), EFieldKind::Object, true});
        ...
        PI_ADD("variable.remove", "type", {TEXT("name"), EFieldKind::String, true});
        PI_ADD("struct.field.add", "type", {TEXT("displayName"), EFieldKind::String, true}, {TEXT("type"), EFieldKind::Object, true}, {TEXT("defaultValue"), EFieldKind::String, false}, {TEXT("tooltip"), EFieldKind::String, false}); PI_ADD("struct.field.update", "type", {TEXT("fieldGuid"), EFieldKind::String, true}, {TEXT("displayName"), EFieldKind::String, true}, {TEXT("type"), EFieldKind::Object, true}, {TEXT("defaultValue"), EFieldKind::String, false}, {TEXT("tooltip"), EFieldKind::String, false}); PI_ADD("struct.field.remove", "type", {TEXT("fieldGuid"), EFieldKind::String, true}); PI_ADD("enum.value.add", "type", {TEXT("displayName"), EFieldKind::String, true}); PI_ADD("enum.value.rename", "type", {TEXT("valueIndex"), EFieldKind::Number, true}, {TEXT("displayName"), EFieldKind::String, true}); PI_ADD("enum.value.remove", "type", {TEXT("valueIndex"), EFieldKind::Number, true}); PI_ADD("enum.bitflags.set", "type", {TEXT("bitflags"), EFieldKind::Boolean, true});
...
#undef PI_ADD
        ...
        const TArray<FString>& OperationNames, FProtocolError& OutError) const
    {
        ...
        TSharedRef<FJsonObject> Result = MakeShared<FJsonObject>(); Result->SetStringField(TEXT("schemaSource"), TEXT("PiUnrealBlueprintOperationRegistry")); Result->SetArrayField(TEXT("operations"), Items); return Result;
    }
        ...
        FWritePipelineRequest& OutRequest, FProtocolError& OutError) const
    {
        ...
        OutRequest = FWritePipelineRequest(); OutRequest.RequestId = RequestId; OutRequest.TransactionDescription = FString::Printf(TEXT("Pi Blueprint apply %s"), *RequestId); OutRequest.Preflight.ExpectedStateHashes = ExpectedStateHashes;
