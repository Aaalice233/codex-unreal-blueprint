...
namespace PiUnrealBlueprint
{
    ...
    struct PIUNREALBLUEPRINTCORE_API FRequestJournalRecord
    {
        FString RequestId;
        FString Method;
        FString PayloadHash;
    ...
    struct PIUNREALBLUEPRINTCORE_API FRequestJournalStatus
    {
        int32 RecordCount = 0;
    ...
    class PIUNREALBLUEPRINTCORE_API FRequestJournal
    {
    public:
