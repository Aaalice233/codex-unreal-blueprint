...
{
    struct PIUNREALBLUEPRINTCORE_API FUmgOperationError
    {
        FString Code;
        FString Message;
        FString AssetPath;
    ...
    struct PIUNREALBLUEPRINTCORE_API FUmgOperationResult
    {
        bool bChanged = false;
        FString AssetPath;
     ...
     * semantics have one implementation for Editor, Commandlet, CLI, and Pi.
     *
     ...
     */
    class PIUNREALBLUEPRINTCORE_API FBlueprintUmgOperations
    {
    public:
