...
{
    struct PIUNREALBLUEPRINTCORE_API FAnimOperationError
    {
        FString Code;
        FString Message;
        FString AssetPath;
    ...
    struct PIUNREALBLUEPRINTCORE_API FAnimOperationResult
    {
        bool bChanged = false;
        FString AssetPath;
        FString GraphPath;
     ...
     */
    class PIUNREALBLUEPRINTCORE_API FBlueprintAnimOperations
    {
    public:
