...
{
    struct PIUNREALBLUEPRINTCORE_API FSourceControlFileState
    {
        FString Filename;
        bool bExists = false;
    ...
    struct PIUNREALBLUEPRINTCORE_API FSourceControlResult
    {
    ...
    class PIUNREALBLUEPRINTCORE_API FWriteSourceControl
    {
    public:
