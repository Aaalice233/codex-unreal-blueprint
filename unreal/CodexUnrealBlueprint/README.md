...
UE4.26/4.27 Editor-only layered asset inspection and Blueprint automation plugin for Codex. It contains four modules:
...
The plugin does not enter runtime targets. Its Niagara specialization uses UE4.26/4.27's built-in Niagara plugin. Enable it in the target `.uproject`, restart the Editor, and connect through the bundled Codex MCP server.
