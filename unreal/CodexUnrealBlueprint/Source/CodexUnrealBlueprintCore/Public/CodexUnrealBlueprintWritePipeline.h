...
{
    struct CODEXUNREALBLUEPRINTCORE_API FWritePipelineError
    {
        FString Code;
        FString Message;
        FString AssetPath;
    ...
    struct CODEXUNREALBLUEPRINTCORE_API FWritePipelineProgress
    {
    ...
    class CODEXUNREALBLUEPRINTCORE_API FWriteMutationContext
    {
    public:
    ...
    struct CODEXUNREALBLUEPRINTCORE_API FWritePackageResult
    {
        FString PackageName;
        FString Filename;
        FString BeforeHash;
    ...
    struct CODEXUNREALBLUEPRINTCORE_API FWritePipelineResult
    {
    ...
    class CODEXUNREALBLUEPRINTCORE_API FWritePipeline
    {
    public:
