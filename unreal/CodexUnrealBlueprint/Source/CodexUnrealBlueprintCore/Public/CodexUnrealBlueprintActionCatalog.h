...
namespace CodexUnrealBlueprint
{
    ...
    struct CODEXUNREALBLUEPRINTCORE_API FGraphActionSearchRequest
    {
        FString Query;
    ...
    struct CODEXUNREALBLUEPRINTCORE_API FGraphActionSearchResult
    {
     ...
     */
    class CODEXUNREALBLUEPRINTCORE_API FBlueprintGraphActionCatalog
    {
    public:
