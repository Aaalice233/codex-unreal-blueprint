...
namespace
{
    ...
    FWritePipelineRequest MakePipelineRequest(UBlueprint* Blueprint, const FString& RequestId, const FName VariableName)
    {
        ...
        Request.TransactionDescription = TEXT("CodexUnrealBlueprint Automation fixture write");
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexPipelinePersistenceIntegrationTest,
    "CodexUnrealBlueprint.Integration.Pipeline.PreflightTransactionCompileSaveReload", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FCodexPipelinePersistenceIntegrationTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexPipelinePreflightRefusalsTest,
    "CodexUnrealBlueprint.FaultInjection.Pipeline.PreflightRefusals", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FCodexPipelinePreflightRefusalsTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexPipelineCompileFailureTest,
    "CodexUnrealBlueprint.FaultInjection.Pipeline.CompileFailure", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FCodexPipelineCompileFailureTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexPipelinePartialSaveFailureTest,
    "CodexUnrealBlueprint.FaultInjection.Pipeline.PartialSaveFailure", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FCodexPipelinePartialSaveFailureTest::RunTest(const FString& Parameters)
{
    ...
    Request.TransactionDescription = TEXT("CodexUnrealBlueprint partial save fixture");
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexPipelinePartialUnknownManifestTest,
    "CodexUnrealBlueprint.FaultInjection.Pipeline.PartialAndStateUnknownManifest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FCodexPipelinePartialUnknownManifestTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexPipelineCancellationBoundaryTest,
    "CodexUnrealBlueprint.FaultInjection.Pipeline.ConcurrentCancellationBoundary", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FCodexPipelineCancellationBoundaryTest::RunTest(const FString& Parameters)
{
