...
#include "CodexUnrealBlueprintTransportLimits.h"
...
namespace CodexUnrealBlueprint
{
    namespace
    {
        ...
        bool ConnectClient(FTransportAutomationFixture& Fixture, FString& OutError)
        {
            ...
            Fixture.ClientSocket = SocketSubsystem->CreateSocket(NAME_Stream, TEXT("CodexUnrealBlueprint automation client"), NAME_None);
    ...
    IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexTransportDescriptorLifecycleTest,
        "CodexUnrealBlueprint.Transport.SessionDescriptorLifecycle",
        EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

    bool FCodexTransportDescriptorLifecycleTest::RunTest(const FString& Parameters)
    {
        const FString Directory = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("CodexUnrealBlueprint"), TEXT("AutomationSessions"), FGuid::NewGuid().ToString());
    ...
    IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexTransportRealRpcTest,
    ...
    IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexTransportRejectsInvalidUtf8Test,
        "CodexUnrealBlueprint.Transport.RejectsInvalidUtf8",
        EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

    bool FCodexTransportRejectsInvalidUtf8Test::RunTest(const FString& Parameters)
    {
    ...
    IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCodexTransportBoundedQueuesTest,
        "CodexUnrealBlueprint.Transport.BoundedQueues",
        EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

    bool FCodexTransportBoundedQueuesTest::RunTest(const FString& Parameters)
    {
