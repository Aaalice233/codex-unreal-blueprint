...
- [ ] 每种写入都证明经过预检、整批 Package 备份、事务、修改、编译、保存、重载、结构验证、Journal 和恢复。
- [ ] 故障注入覆盖编译/保存/磁盘/Source Control 失败、Dirty Package、不同断线时点、崩溃、部分保存和恢复冲突，且不会返回“部分成功”。
...
- [ ] 中英文 setup、Tool/CLI、Source Control、恢复、贡献和安全文档与真实实现一致。
