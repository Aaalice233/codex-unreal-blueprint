...
- [ ] Every write proves preflight, complete-package backup, transaction, mutation, compile, save, reload, structural verification, journal, and recovery.
- [ ] Failure injection covers compile/save/disk/source-control failure, dirty packages, disconnect timing, crash, partial save, and recovery conflict without partial-success responses.
...
- [ ] English and Chinese setup, Tool/CLI reference, source control, recovery, contribution, and security documentation match implemented behavior.
