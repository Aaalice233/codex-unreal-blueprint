...
const RPC_METHODS: Readonly<Record<ToolName, string>> = {
  ...
  unreal_asset_inspect: "unreal.asset.inspect",
  unreal_asset_compare: "unreal.asset.compare",
  unreal_asset_referencers: "unreal.asset.referencers",
  unreal_viewport_list: "unreal.viewport.list",
  unreal_viewport_capture: "unreal.viewport.capture",
