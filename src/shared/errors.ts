...
export const ERROR_CODES = {
  ...
  PLUGIN_COPY_FAILED: "PLUGIN_COPY_FAILED",
  COMMANDLET_START_FAILED: "COMMANDLET_START_FAILED",
  COMMANDLET_RESULT_MISSING: "COMMANDLET_RESULT_MISSING",
  COMMANDLET_FAILED: "COMMANDLET_FAILED",
